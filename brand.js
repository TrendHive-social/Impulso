document.getElementById('nicheForm').addEventListener('submit', function(event) {
    ...
    const brands = {
        ...
        lifestyle: [
            ...
            { name: 'Home Decor', contact: 'contact@homedecor.com', criteria: 'Focus on home decor inspiration', img: 'brand32.jpg' },
            { name: 'Wellness Wisdom', contact: 'contact@wellnesswisdom.com', criteria: 'Must post wellness advice', img: 'brand33.png' },
            { name: 'Personal Growth', contact: 'contact@personalgrowth.com', criteria: 'Must feature personal development', img: 'brand34.jpg' },
            { name: 'Relationship Goals', contact: 'contact@relationshipgoals.com', criteria: 'Focus on relationship advice', img: 'brand35.png' }
        ],
        beauty: [
            { name: 'Beauty Buzz', contact: 'contact@beautybuzz.com', criteria: 'Must post beauty tutorials', img: 'brand36.jpg' },
            { name: 'Skincare Savvy', contact: 'contact@skincareasavvy.com', criteria: 'Focus on skincare routines', img: 'brand37.avif' },
            { name: 'Makeup Mastery', contact: 'contact@makeupmastery.com', criteria: 'Must feature makeup tutorials', img: 'brand38.jpg' },
            { name: 'Hair Care Hub', contact: 'contact@haircarehub.com', criteria: 'Must post hair care tips', img: 'brand39.avif' },
            { name: 'Nail Artistry', contact: 'contact@nailartistry.com', criteria: 'Focus on nail art designs', img: 'brand40.jpg' }
        ],
        parenting: [
            { name: 'Parenting Pro', contact: 'contact@parentingpro.com', criteria: 'Must post parenting tips', img: 'brand41.jpg' },
            { name: 'Kids\' Corner', contact: 'contact=kids@corner.com', criteria: 'Focus on kids\' activities', img: 'brand42.jpg' },
            { name: 'Family Fun', contact: 'contact@familyfun.com', criteria: 'Must feature family bonding ideas', img: 'brand43.jpg' },
            { name: 'Baby Bliss', contact: 'contact@babybliss.com', criteria: 'Must post baby care tips', img: 'brand44.avif' },
            { name: 'Toddler Tales', contact: 'contact@toddlertales.com', criteria: 'Focus on toddler development', img: 'brand45.jpg' }
        ],
        finance: [
            ...
            { name: 'Wealth Wisdom', contact: 'contact@wealthwisdom.com', criteria: 'Must post wealth-building strategies', img: 'brand49.jpg' },
            { name: 'Credit Counsel', contact: 'contact@creditcounsel.com', criteria: 'Focus on credit management', img: 'brand50.webp' }
        ]
    };
